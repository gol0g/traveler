...
## KR ETF Momentum (KODEX200 Timing)

### 2026-03-09: RSI(14)>70 과매수 필터 추가
- **변경**: KODEX200 RSI(14) > 70이면 ETF 모멘텀 진입 보류
- **배경**: 069500 3/4 진입 시 RSI=82 (극단적 과매수) → 다음날 -12.4% SL 청산, 3/9 재진입 -7.9%
- **백테스트**: `go run ./cmd/backtest-stock/ -market kr -capital 797000`
  - 120일: 필터 없음 -6.1% → **필터 적용 -3.6%** (+2.5%p, Sharpe -0.71→-0.33)
  - 240일: 필터 없음 **-18.4%** → **필터 적용 -9.9%** (+8.5%p, Sharpe -1.52→-0.66, MDD 20.5%→14.1%)
- **사유**: RSI>70은 과매수 반전 신호인데, 기존 조건(RSI>45)은 상한 체크 없이 통과시킴
